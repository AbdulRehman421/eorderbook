...
class DistributorWIse extends StatefulWidget {
  ...
  @override
  _DistributorWIseState createState() => _DistributorWIseState();
}

class _DistributorWIseState extends State<DistributorWIse> {
