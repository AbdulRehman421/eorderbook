...
class GetCompanyProducts extends StatefulWidget {
  final String mainCode;
  final String distCode;
  final String compCode;
  GetCompanyProducts({required this.mainCode,required this.distCode,required this.compCode});

  @override
  _GetCompanyProductsState createState() => _GetCompanyProductsState();
}

class _GetCompanyProductsState extends State<GetCompanyProducts> {
  ...
  Future<void> fetchProfit() async {
    final url = Uri.parse('https://seasoftsales.com/eorderbook/get_stock_product.php?companycode=${widget.compCode}&dist_code=${widget.distCode}');
