...
class ExpiryCompanyProductWIse extends StatefulWidget {
  final String mainCode;
  final String distCode;
  final String days;
  final String cCode;
  ExpiryCompanyProductWIse({required this.mainCode,required this.distCode,required this.days,required this.cCode});

  @override
  _ExpiryCompanyProductWIseState createState() => _ExpiryCompanyProductWIseState();
}

class _ExpiryCompanyProductWIseState extends State<ExpiryCompanyProductWIse> {
