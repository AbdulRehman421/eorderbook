...
class ExpiryProductWIse extends StatefulWidget {
  final String mainCode;
  final String distCode;
  final String days;
  ExpiryProductWIse({required this.mainCode,required this.distCode,required this.days});

  @override
  _ExpiryProductWIseState createState() => _ExpiryProductWIseState();
}

class _ExpiryProductWIseState extends State<ExpiryProductWIse> {
  ...
  Future<void> fetchProfit(String distcode) async {
    final url = Uri.parse('https://seasoftsales.com/eorderbook/get_stock_product.php?days=${widget.days}&dist_code=${widget.distCode}');
