...
class ExpiryDistributorCompanyProductWIse extends StatefulWidget {
  final String mainCode;
  final String distCode;
  final String days;
  final String cCode;
  ExpiryDistributorCompanyProductWIse({required this.mainCode,required this.distCode,required this.days,required this.cCode});

  @override
  _ExpiryDistributorCompanyProductWIseState createState() => _ExpiryDistributorCompanyProductWIseState();
}

class _ExpiryDistributorCompanyProductWIseState extends State<ExpiryDistributorCompanyProductWIse> {
  ...
  Future<void> _refreshData() async {
    fetchProfit(widget.distCode);
  }
  Future<void> fetchProfit(String distcode) async {
    final url = Uri.parse('https://seasoftsales.com/eorderbook/get_stock_product.php?days=${widget.days}&dist_code=${widget.distCode}&companycode=${widget.cCode}');
