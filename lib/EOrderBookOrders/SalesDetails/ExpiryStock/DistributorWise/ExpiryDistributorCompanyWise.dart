import 'dart:convert';
import 'package:eorderbook/EOrderBookOrders/SalesDetails/ExpiryStock/DistributorWise/ExpiryDistributorCompanyProductWise.dart';
...
class ExpiryDistributorCompanyWIse extends StatefulWidget {
  ...
  ExpiryDistributorCompanyWIse({required this.mainCode,required this.distCode,required this.days,required this.startDate, required this.endDate , required this.cdistCode});

  @override
  _ExpiryDistributorCompanyWIseState createState() => _ExpiryDistributorCompanyWIseState();
}

class _ExpiryDistributorCompanyWIseState extends State<ExpiryDistributorCompanyWIse> {
  ...
  Future<void> fetchProfit(String distcode, String startDate, String endDate) async {
    final url = Uri.parse('https://seasoftsales.com/eorderbook/get_stock_distributor_company.php?cdist_code=${widget.cdistCode}&dist_code=${widget.distCode}&days=${widget.days}');
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return Column(
                        children: [
                          GestureDetector(
                            onTap : (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => ExpiryDistributorCompanyProductWIse(days: widget.days,mainCode: widget.mainCode, distCode: widget.distCode, cCode: invoice['companycode']),));
                      },
                            child: Card(
                              child: Column(
