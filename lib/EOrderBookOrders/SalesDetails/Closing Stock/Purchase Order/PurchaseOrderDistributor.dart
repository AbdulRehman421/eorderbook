...
import 'PurchaseOrderDistributorCustomer.dart';

class PurchaseOrderDistributor extends StatefulWidget {
  ...
  @override
  _PurchaseOrderDistributorState createState() => _PurchaseOrderDistributorState();
}

class _PurchaseOrderDistributorState extends State<PurchaseOrderDistributor> {
  ...
  Future<void> fetchProfit(
    ...
    final url = Uri.parse(
        'https://seasoftsales.com/eorderbook/get_stock_distributor.php?&dist_code=${widget.distCode}');
                          ...
                          GestureDetector(
                            onTap: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        PurchaseOrderDistributorCustomer(
