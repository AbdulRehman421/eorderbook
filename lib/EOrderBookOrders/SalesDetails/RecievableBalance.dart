...
class RecievableBalance extends StatefulWidget {
  final String mainCode;
  final String distCode;
  final String startDate;
  final String endDate;
  RecievableBalance({required this.mainCode,required this.distCode,required this.startDate, required this.endDate});

  @override
  _RecievableBalanceState createState() => _RecievableBalanceState();
}

class _RecievableBalanceState extends State<RecievableBalance> {
