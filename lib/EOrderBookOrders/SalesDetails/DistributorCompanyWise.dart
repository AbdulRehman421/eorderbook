...
class DistributorCompanyWIse extends StatefulWidget {
  final String mainCode;
  final String distCode;
  final String cdistCode;
  final String startDate;
  final String endDate;
  DistributorCompanyWIse({required this.mainCode,required this.distCode,required this.startDate, required this.endDate , required this.cdistCode});

  @override
  _DistributorCompanyWIseState createState() => _DistributorCompanyWIseState();
}

class _DistributorCompanyWIseState extends State<DistributorCompanyWIse> {
