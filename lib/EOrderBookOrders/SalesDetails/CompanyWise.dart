...
class CompanyWIse extends StatefulWidget {
  final String mainCode;
  final String distCode;
  final String startDate;
  final String endDate;
  CompanyWIse({required this.mainCode,required this.distCode,required this.startDate, required this.endDate});

  @override
  _CompanyWIseState createState() => _CompanyWIseState();
}

class _CompanyWIseState extends State<CompanyWIse> {
  ...
  Future<void> fetchProfit(String distcode, String startDate, String endDate) async {
    final url = Uri.parse('https://seasoftsales.com/eorderbook/get_stock_company.php?&dist_code=${widget.distCode}');
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return Column(
                        children: [
                          GestureDetector(
                            onTap : (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => GetCompanyProducts(mainCode: widget.mainCode, distCode: widget.distCode, compCode: invoice['companycode']),));
                      },
                            child: Card(
                              child: Column(
