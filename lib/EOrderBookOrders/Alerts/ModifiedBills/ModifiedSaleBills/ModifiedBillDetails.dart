...
class ModifiedBillDetails extends StatefulWidget {
  final String orderId;
  String type;
  final String distCode;
  final String startDate;
  final String endDate;
  ModifiedBillDetails({required this.orderId, required this.distCode, required this.type, required this.startDate, required this.endDate});

  @override
  _ModifiedBillDetailsState createState() => _ModifiedBillDetailsState();
}

class _ModifiedBillDetailsState extends State<ModifiedBillDetails> {
  ...
  Future<void> fetchProfit(String distcode, String startDate, String endDate) async {
    final url = Uri.parse('https://seasoftsales.com/eorderbook/get_modified_invoices_detail.php?invno=${widget.orderId}&type=${widget.type}&dist_code=${widget.distCode}&start_date=$startDate&end_date=$endDate');
