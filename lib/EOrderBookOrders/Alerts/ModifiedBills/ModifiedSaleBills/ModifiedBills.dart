import 'dart:convert';
import 'package:eorderbook/EOrderBookOrders/Alerts/ModifiedBills/ModifiedSaleBills/ModifyBillSummary.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;

class ModifiedBills extends StatefulWidget {
  final String type;
  final String distCode;
  final String startDate;
  final String endDate;

  ModifiedBills({required this.distCode, required this.type, required this.startDate, required this.endDate});

  @override
  _ModifiedBillsState createState() => _ModifiedBillsState();
}

class _ModifiedBillsState extends State<ModifiedBills> {
  ...
  Future<void> fetchProfit(String distcode, String startDate, String endDate) async {
    final url = Uri.parse('https://seasoftsales.com/eorderbook/get_modified_invoices.php?type=${widget.type}&dist_code=${widget.distCode}&start_date=$startDate&end_date=$endDate');
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return Column(
                        children: [
                          GestureDetector(
                            onTap : (){
                              Navigator.push(context, MaterialPageRoute(builder: (context) => ModifiedBillSummary(distCode: widget.distCode, invno: invoice['invno'], type: widget.type, startDate: widget.startDate, endDate: widget.endDate),));
                            },
                            child: Card(
                              child: Column(
