...
class DiscountedProducts extends StatefulWidget {
  ...
  DiscountedProducts({required this.dip, required this.distCode, required this.startDate, required this.endDate});
...
class _DiscountedProductsState extends State<DiscountedProducts> {
  ...
  Future<void> fetchProfit(String distcode, String startDate, String endDate) async {
    final url = Uri.parse('https://seasoftsales.com/eorderbook/get_discounted_products.php?dip=${widget.dip}&type=33&dist_code=${widget.distCode}&start_date=$startDate&end_date=$endDate');
