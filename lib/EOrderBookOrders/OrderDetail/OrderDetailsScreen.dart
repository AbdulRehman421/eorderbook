import 'dart:convert';
import 'package:eorderbook/EOrderBookOrders/OrderDetail/AllDetailsOrder.dart';
      ...
      body: Column(
        ...
        children: [
          if (!isLoading && orderData.isNotEmpty)
            Center(
                child: Text('Orders Amount : ${calculateTotalOrderAmount().toStringAsFixed(2)}',
                  style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.bold
                  ),
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => AllOrderDetails(distCode: widget.distCode, order_id: item['order_id']),));
                    },
                    child: Card(
                      child: Row(
      ...
      floatingActionButton: Visibility(
        ...
        child: FloatingActionButton.extended(
          onPressed: () async {
            ...
            Navigator.push(context, MaterialPageRoute(builder: (context) => OrderMap(distcode: widget.distCode, username: username.toString(), selectedDates: widget.selectedDate),));
          },
          label: Text('Map View'),
        ),
      ),
