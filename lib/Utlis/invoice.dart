...
import 'DynamicPdfSizeScreen.dart';
import 'Utility.dart';
import 'Utils.dart';
...
Future<void> _saveAsFile(BuildContext context, LayoutCallback build,
  ...
  final file = File(appDocPath + '/' + '${_myData!.date}.pdf');
...
class _MyPdfWidgetState extends State<MyPdfWidget> {
  ...
  Future<void> openBox() async {
    ...
    // setState(() {
    //   widget.myData.willShowPhone = box1.get(widget.myData.date) ?? false;
    // });
  }
}
...
class Invoice {
  Invoice( {
    required this.tax, required this.paymentInfo,
  ...
  Future<Uint8List> buildPdf(PdfPageFormat pageFormat, MyData myData) async {
    ...
    // List<Map<String, dynamic>> info=await myData.invoiceNumber;

    // _logo = await rootBundle.loadString('assets/assets/medail.svg');
    // _bgShape = await rootBundle.loadString('assets/assets/bg2.svg');
              ...
              children: [
                ...
                myData.total == 0
                    ...
                    : pw.Row(
                        ...
                        children: [
                          ...
                          pw.Text(
                              "${(_total * myData.total).toStringAsFixed(0)}"),
                        ],
                      ),
                myData.total == 0
                    ? pw.Container(height: 0, width: 0)
                ...
                myData.total == 0
                    ...
                    : pw.Row(
                        ...
                        children: [
                          pw.Text(
                              'Vat(+${(myData.total * 100).toStringAsFixed(0)}%):'),
                          pw.Text(
                              "${(_total * myData.total).toStringAsFixed(0)}"),
                        ],
                      ),
                ...
                pw.DefaultTextStyle(
                  ...
                  child: pw.Row(
                    ...
                    children: [
                      pw.Text('Total:'),
                      pw.Text((myData.total.toString()).toString()),
                    ],
                  ),
                ),
                pw.DefaultTextStyle(
                ...
                pw.DefaultTextStyle(
                  ...
                  child: pw.Row(
                    ...
                    children: [
                      pw.Text('Due Amount:'),
                      pw.Text(_formatCurrency(myData.total)),
                    ],
                  ),
                ),
              ],
  ...
  pw.Widget _contentMainHeader(
      pw.Context context, MyData myData, String? imageString, pw.Document doc,double width,double height) {
    return pw.Column(
      children: [
//         pw.Row(
//           crossAxisAlignment: pw.CrossAxisAlignment.center,
...
*/
                  ...
                  pw.Container(
                      ...
                      child: pw.Row(
                          ...
                          pw.MainAxisAlignment.start,
                          children: [
                            pw.Text("Sector: ${myData.customer.areaCd}",
                                softWrap: false,
                                style: pw.TextStyle(
                                    fontSize: 10,
                                    fontWeight: pw.FontWeight.bold)),
                            ...
                            children: [
                              pw.Text("Phone : ",
                                  style: pw.TextStyle(
                                      fontSize: 8,
                                      fontWeight: pw.FontWeight.bold)),
                              pw.Text(myData.customer.address,
